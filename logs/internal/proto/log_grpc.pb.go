...
type LogServiceClient interface {
	...
	GetLogs(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*LogsResponse, error)
}
...
func (c *logServiceClient) GetLogs(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*LogsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type LogServiceServer interface {
	...
	GetLogs(context.Context, *EmptyRequest) (*LogsResponse, error)
...
func (UnimplementedLogServiceServer) GetLogs(context.Context, *EmptyRequest) (*LogsResponse, error) {
...
func _LogService_GetLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).GetLogs(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
